...
void AppDelegate::initGLContextAttrs()
{
	...
	cocos2d::log("AppDelegate:initGLContextAttrs called");
}
...
bool AppDelegate::applicationDidFinishLaunching() {
	...
	if(!glview) {
		...
		glview = GLViewImpl::createWithRect("helloword", Rect(0, 0, designResolutionSize.width, designResolutionSize.height));
#else
	...
	/*SimpleAudioEngine::getInstance()->preloadEffect(hit_sound);
	SimpleAudioEngine::getInstance()->preloadEffect(point_sound);
